...
namespace E3DBPI.Controllers
{
    public class OrderStatusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderStatusID,OrderStatus,Description,Active")] OrderStatu orderStatu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderStatusID,OrderStatus,Description,Active")] OrderStatu orderStatu)
        {
            if (ModelState.IsValid)
            {
