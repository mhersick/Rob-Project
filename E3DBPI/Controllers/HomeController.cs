...
namespace E3DBPI.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            ViewBag.Message = "Accessibility page.";
        ...
        {
            ViewBag.Message = "Terms of Use page page.";
        ...
        public ActionResult DMCApoicy()
        {
            ViewBag.Message = "DMCA Policy page.";
        ...
        {
            ViewBag.Message = "Press Room page.";
        ...
        {
            ViewBag.Message = "White Paper page (Case Studies).";

            return View();
        }

        public ActionResult AECnews()
        {
            ViewBag.Message = "AEC News page.";

            return View();
        }

        public ActionResult AffiliateStart()
        {
            ViewBag.Message = "Affiliate - Get Started";
        ...
        {
            ViewBag.Message = "Affiliate - Learn More";
        ...
        {
            ViewBag.Message = "Application Features page";
